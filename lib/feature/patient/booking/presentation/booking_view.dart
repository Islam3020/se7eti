...
import 'package:se7eti/core/widgets/alert_dialog.dart';
import 'package:se7eti/core/widgets/custom_button.dart';
import 'package:se7eti/core/widgets/doctor_card.dart';
import 'package:se7eti/feature/auth/data/models/doctor_model.dart';
import 'package:se7eti/feature/patient/booking/data/available_appointments.dart';
...
class _BookingViewState extends State<BookingView> {
  ...
  getAvailableTimes(selectedDate) async {
    final newTimes = getAvailableAppointments(selectedDate,
        widget.doctor.openHour ?? "0", widget.doctor.closeHour ?? "0");
         print('New Available Times: $newTimes');

    setState(() {
      times = newTimes;
      selectedIndex = -1; // لإعادة تعيين الاختيار عند تغيير التاريخ
      booking_hour = null;
    });
  }
